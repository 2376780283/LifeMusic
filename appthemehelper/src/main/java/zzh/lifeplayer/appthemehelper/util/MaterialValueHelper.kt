...
object MaterialValueHelper {
    ...
    @JvmStatic
    @ColorInt
    fun getPrimaryDisabledTextColor(
        context: Context?,
        dark: Boolean,
    ): Int =
        if (dark) {
            ...
            ContextCompat.getColor(context!!, androidx.appcompat.R.color.primary_text_disabled_material_dark)
        }

    @SuppressLint("PrivateResource")
    @JvmStatic
    @ColorInt
    fun getSecondaryDisabledTextColor(
        context: Context?,
        dark: Boolean,
    ): Int =
        if (dark) {
            ...
            ContextCompat.getColor(context!!, androidx.appcompat.R.color.secondary_text_disabled_material_dark)
        }
}
