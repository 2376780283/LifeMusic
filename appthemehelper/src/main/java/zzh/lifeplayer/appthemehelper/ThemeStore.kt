...
class ThemeStore
    private constructor(
        ...
        override fun primaryColorRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = primaryColor(ContextCompat.getColor(mContext, colorRes))

        override fun primaryColorAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = primaryColor(resolveColor(mContext, colorAttr))

        override fun primaryColorDark(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun primaryColorDarkRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = primaryColorDark(ContextCompat.getColor(mContext, colorRes))

        override fun primaryColorDarkAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = primaryColorDark(resolveColor(mContext, colorAttr))
        ...
        override fun accentColorRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = accentColor(ContextCompat.getColor(mContext, colorRes))

        override fun accentColorAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = accentColor(resolveColor(mContext, colorAttr))

        override fun statusBarColor(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun statusBarColorRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = statusBarColor(ContextCompat.getColor(mContext, colorRes))

        override fun statusBarColorAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = statusBarColor(resolveColor(mContext, colorAttr))

        override fun navigationBarColor(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun navigationBarColorRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = navigationBarColor(ContextCompat.getColor(mContext, colorRes))

        // Static getters

        override fun navigationBarColorAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = navigationBarColor(resolveColor(mContext, colorAttr))

        override fun textColorPrimary(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun textColorPrimaryRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = textColorPrimary(ContextCompat.getColor(mContext, colorRes))

        override fun textColorPrimaryAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = textColorPrimary(resolveColor(mContext, colorAttr))

        override fun textColorPrimaryInverse(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun textColorPrimaryInverseRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = textColorPrimaryInverse(ContextCompat.getColor(mContext, colorRes))

        override fun textColorPrimaryInverseAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = textColorPrimaryInverse(resolveColor(mContext, colorAttr))

        override fun textColorSecondary(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun textColorSecondaryRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = textColorSecondary(ContextCompat.getColor(mContext, colorRes))

        override fun textColorSecondaryAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = textColorSecondary(resolveColor(mContext, colorAttr))

        override fun textColorSecondaryInverse(
            @ColorInt color: Int,
        ): ThemeStore {
        ...
        override fun textColorSecondaryInverseRes(
            @ColorRes colorRes: Int,
        ): ThemeStore = textColorSecondaryInverse(ContextCompat.getColor(mContext, colorRes))

        override fun textColorSecondaryInverseAttr(
            @AttrRes colorAttr: Int,
        ): ThemeStore = textColorSecondaryInverse(resolveColor(mContext, colorAttr))
        ...
        companion object {
            ...
            @CheckResult
            @StyleRes
            fun activityTheme(context: Context): Int = prefs(context).getInt(ThemeStorePrefKeys.KEY_ACTIVITY_THEME, 0)
