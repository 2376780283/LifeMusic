...
object PermissionUtil {
    ...
    fun isPermissionGranted(context: Context, permissions: Array<String>): Boolean =
        permissions.filter { isPermissionGranted(context, it) }.size == permissions.size

    /**
     * Check if Specified Permission is defined in AndroidManifest.xml file or not. If permission is
     * defined in manifest then return true else return false.
     *
     * @param context Application Context
