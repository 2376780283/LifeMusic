...
import zzh.lifeplayer.music.util.FileUtils.createFile
import zzh.lifeplayer.music.util.Share.shareFile
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        moreInfoButton.setOnClickListener { // We retrieve all the error data and show it
            MaterialAlertDialogBuilder(this@ErrorActivity)
                ...
                .setMessage(
                    CustomActivityOnCrash.getAllErrorDetailsFromIntent(this@ErrorActivity, intent)
                )
                .setPositiveButton(
                    cat.ereza.customactivityoncrash.R.string
        ...
        if (errorActivityDrawableId != null) {
            errorImageView.setImageResource(errorActivityDrawableId)
        }
    }
}
