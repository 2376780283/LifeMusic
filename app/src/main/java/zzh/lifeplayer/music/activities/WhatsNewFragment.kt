...
import zzh.lifeplayer.music.databinding.FragmentWhatsNewBinding
import zzh.lifeplayer.music.extensions.accentColor
import zzh.lifeplayer.music.extensions.openUrl
import zzh.lifeplayer.music.util.PreferenceUtil.lastVersion
...
class WhatsNewFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val accentTextColor =
                colorToCSS(getPrimaryTextColor(requireContext(), isColorLight(accentColor)))
            val changeLog =
                buf.toString()
                    .replace(
                        "{style-placeholder}",
        ...
        binding.tgFab.setOnClickListener { openUrl(Constants.TELEGRAM_CHANGE_LOG) }
