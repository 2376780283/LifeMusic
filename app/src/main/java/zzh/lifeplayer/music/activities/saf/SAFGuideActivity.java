  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(zzh.lifeplayer.appthemehelper.R.color.md_deep_purple_300)
            .backgroundDark(zzh.lifeplayer.appthemehelper.R.color.md_deep_purple_400)
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(zzh.lifeplayer.appthemehelper.R.color.md_deep_purple_500)
            .backgroundDark(zzh.lifeplayer.appthemehelper.R.color.md_deep_purple_600)
            .layout(R.layout.fragment_simple_slide_large_image)
            .build());
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(zzh.lifeplayer.appthemehelper.R.color.md_deep_purple_700)
