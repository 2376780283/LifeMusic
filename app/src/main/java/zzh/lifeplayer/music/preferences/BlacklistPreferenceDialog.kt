...
import zzh.lifeplayer.music.dialogs.BlacklistFolderChooserDialog
import zzh.lifeplayer.music.extensions.accentTextColor
...
class BlacklistPreferenceDialog : DialogFragment(), BlacklistFolderChooserDialog.FolderCallback {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val chooserDialog =
            childFragmentManager.findFragmentByTag("FOLDER_CHOOSER")
                as BlacklistFolderChooserDialog?
